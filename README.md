...
rest of the table waits on Phase 18's harness; the agents it would grade now
exist, and none of these numbers has been measured yet.
...
| 12    | Report generation: the structured report, citations by source, a validator that proves each one                   | Next    |
| 13+   | Workers, streaming, caching, evaluation, observability, load testing, deployment                                  | Planned |
...
| 3   | Web research, real searching, fetching, parsing, and citations                                | Partly      | Searching, fetching and parsing are built (Phase 6) and driven by the researchers (Phase 10). Claims, their evidence spans and their sources are persisted (Phase 11); the citations that point at them are Phase 12. |
