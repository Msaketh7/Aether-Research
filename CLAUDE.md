...
**Phases 0–18 of 25 are complete.** Full plan and per-phase status:
...
| API (`apps/api`)                | FastAPI: research surface, file uploads, SSE, authorisation, error contract, health probes, `/metrics`, `/evaluations`. 1159 tests.                                                                                                                                                                                                                                                                                                                    |
