...
| API (`apps/api`)                      | FastAPI: research surface, file uploads, SSE, authentication and authorisation, rate limiting, error contract, health probes, `/metrics`, `/evaluations`, `/settings`. 1332 tests.                                                                                                                                                                                                                                                                                                                                                   |
