> **FROZEN SNAPSHOT: TDD v1.0 (2026-09-05)**
> Immutable copy of `docs/TDD.md` at decision version 1.0 (initial
> specification). The living master is [`docs/TDD.md`](../TDD.md); it may carry
