> **FROZEN SNAPSHOT: PRD v1.0 (2026-09-05)**
> Immutable copy of `docs/PRD.md` at decision version 1.0 (initial
> specification). The living master is [`docs/PRD.md`](../PRD.md); it may carry
> later editorial revisions that are not separately versioned. Do not edit
> this file. See [`docs/CHANGELOG.md`](../CHANGELOG.md).
